...
class PostController extends Controller
{
    ...
    if ($request->hasFile('photo')) {
      ...
      $file->move(public_path('images/posts/'), $fileName); // Move the file to the public/images directory
        $data['photo'] = 'images/posts/' . $fileName;  // Store the image path as a string
    }
