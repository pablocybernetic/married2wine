    ...
    public function store(Request $request)
{
    ...
    if ($request->hasFile('photo')) {
      ...
      $file->move(public_path('images/products/'), $fileName); // Move the file to the public/images directory
        $data['photo'] = 'images/products/' . $fileName;  // Store the image path as a string
    }
