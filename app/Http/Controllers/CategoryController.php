...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('photo')) {
          ...
          $file->move(public_path('images/category/'), $fileName); // Move the file to the public/images directory
            $data['photo'] = 'images/category/' . $fileName; // Store the image path as a string
        }
