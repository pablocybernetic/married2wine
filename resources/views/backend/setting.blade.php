...
<div class="card">
    ...
    <form method="post" action="{{route('settings.update')}}" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <textarea class="form-control" id="quote" name="short_des">{{ $data ? $data->short_des : 'No description added' }}</textarea>
          @error('short_des')
        ...
        <div class="form-group">
          ...
          <textarea class="form-control" id="description" name="description">{{ $data ? $data->description : 'No description added'}}</textarea>
          @error('description')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
